return {
  ...
  config = function(_, opts)
    ...
    vim.keymap.set("n", "<space>fd", function() require("telescope.builtin").find_files { hidden = true } end)
    -- Find files using git's root of the working tree as base directory.
    vim.keymap.set("n", "<space>fg", function() require("telescope.builtin").git_files { show_untracked = true } end)
